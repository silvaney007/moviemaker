...
export const discovery = () => axios.create({baseURL: `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&sort_by=revenue.desc&include_adult=false&include_video=false&page=1&release_date.lte=${currentDate}`})