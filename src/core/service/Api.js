...
export const youTube = (title) => axios.create({ baseURL: `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&order=relevance&q=${encodeURIComponent(title)}&key=${process.env.REACT_APP__API__KEY_YOUTUBE}` });
